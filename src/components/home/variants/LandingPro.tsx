...
const FAQS: [string, string][] = [
  ...
  ["What makes the Longbow a good budget pickleball paddle?", "Most \"budget\" paddles cut corners on the core or face material to hit a low price. The Longbow uses the same carbon-fiber-and-foam construction as $250 paddles, just sold direct at $99.99 without a retail markup — that's what makes it a genuinely good budget option instead of just a cheap one."],
  ["Is a foam core or polymer core better for a pickleball paddle?", "Foam cores (like the Longbow's multi-density notched foam) generally give a bigger sweet spot and more forgiveness on off-center hits, while polymer honeycomb cores tend to feel softer and quieter. Neither is objectively \"better\" — foam cores are usually the better fit for players who want more power and pop, which is why we built the Longbow around one."],
  ["What's the cheapest pickleball paddle that's actually good?", "Cheap paddles under $40-50 are usually a genuine downgrade — thin faces, basic cores, short lifespan. The Longbow is priced at $99.99, which is the low end of \"actually good\" — carbon-fiber face, foam core, built to the same spec as $250 paddles — rather than the lowest price point overall."],
