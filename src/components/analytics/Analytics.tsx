...
/**
 * Injects analytics + marketing pixels only when their env IDs are present.
 * Supported: Google Analytics 4, Microsoft Clarity, Meta Pixel, TikTok Pixel.
 * Google Search Console verification is handled via metadata / DNS.
 */
